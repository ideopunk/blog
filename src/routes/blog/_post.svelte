...
<div class="sm:mx-auto text-xl max-w-[60ch] mt-8 px-2 min-h-screen">
	...
	<article
		class={`prose-lg max-w-[60ch] md:prose-xl dark:prose-invert mt-4 mb-8 group  prose-li:list-disc prose
